...
const Consultation_encaissements_en_provenance_banques = () => {
    return (
        <div>
            <h1>CONSULTATION DES ENCAISSEMENTS DES COTISATIONS EN PROVENANCE DES BANQUES</h1>
...
export default Consultation_encaissements_en_provenance_banques;
