...
const Extraction_encaissement_employeurs = () => {
    return (
        <div>

            <h1>ETAT DES COTISATIONS VERSEES PAR LES EMPLOYEURS</h1>

            <table>
                <thead>
                    <tr>
                        <th>Centre CNPS</th>
                        <th>Centre des impots</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select id="search-option">
                                <option value="actif">Choisir un cdi (ce champ n'est pas obligatiore)</option>
                                <option value="#">###</option>
                            </select>
                        </td>
                        <td>
                        ...
                        <td>
                            <select id="search-option">
                                <option value="actif">Choix</option>
                                <option value="#">###</option>
                            </select>
                        </td>
                        <td>
...
export default Extraction_encaissement_employeurs;