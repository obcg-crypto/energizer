...
const Brouillard_Vires_Microfinances = () => {
    ...
    return (
        <div>
            ...
            <h3>BROUILLARD VIREMENT DES PRESTATIONS PAR MOIS</h3>

            <div class="paragraph">
                <p class="paragraph-child">Centre: 12</p>
                <p class="paragraph-child">Mois : 12013</p>
...
export default Brouillard_Vires_Microfinances;
