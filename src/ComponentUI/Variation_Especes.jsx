...
const Variation_Especes = () => {
    ...
    return (
        <div>
            ...
            <h3>BROUILLARD DES ESPECES DU : 12 PAR RAPPORT AU 12</h3>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>Droit Nominal</th>
                        <th>Trimestre Antérieur</th>
                        <th>Trimestre Actuel</th>
                        <th>Diff</th>
                        <th>Observations</th>
                    </tr>
                </thead>
...
export default Variation_Especes;
