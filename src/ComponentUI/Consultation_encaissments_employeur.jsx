...
const Consultation_encaissments_employeur = () => {
    return (
        <div>
            <h1>CONSULTATION DES COTISATIONS VERSEES PAR LES EMPLOYEURS</h1>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select id="search-option">
                                <option value="centreSvp">Mois</option>
                                <option value="centreSvp">###</option>
                            </select>
                        </td>
                        <td>
                            <select id="search-option">
                                <option value="centreSvp">Annnée</option>
                                <option value="centreSvp">###</option>
                            </select>
                        </td>
                        <td>
                            <select id="search-option">
                                <option value="centreSvp">Suivant date de saisie</option>
                                <option value="centreSvp">#</option>
                                <option value="centreSvp">#</option>
                            </select>
                        </td>
...
export default Consultation_encaissments_employeur;
