...
import '../styles/Nombre_Dossiers_Avec_Statut_Par_Nature_Prestations.css';

const Nombre_Dossiers_Avec_Statut_Par_Nature_Prestations = () => {
    return (
        <div class="table-container">

            <h2 class="first-div">Nombre de Dossiers (Avec Statut) Par Nature de Prestations : CNPS SIEGE</h2>
