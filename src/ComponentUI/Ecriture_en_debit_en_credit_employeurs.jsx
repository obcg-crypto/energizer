...
const Ecriture_en_debit_en_credit_employeurs = () => {
    return (
        <div>

                <h1>Débit credit employeurs</h1>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select id="search-option">
                                <option value="centreSvp">Choisir un CDI</option>
...
export default Ecriture_en_debit_en_credit_employeurs;
