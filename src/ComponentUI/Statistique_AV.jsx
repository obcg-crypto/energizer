...
const Statistique_AV = () => {
    return (
        <div>

            <h1>ETAT DE GESTION ASSURANCE VOLONTAIRE</h1>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select id="search-option">
                                <option value="centreSvp">yvonne.ndoumbe.tq</option>
                                <option value="centreSvp">#</option>
                                <option value="centreSvp">#</option>
                            </select>
                        </td>
            ...
            <h3>STATISTIQUE DES AFFILIATIONS EN ASSURANCE VOLONTAIRE PAR CENTRE AU</h3>
