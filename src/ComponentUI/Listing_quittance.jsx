...
const Listing_quittance = () => {
    return (
        <div>
            <h1>Consultation des quittances établies</h1>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                        <select id="search-option">
                                <option value="VALIDATION DEBIT">Suivant date de génération</option>
                                <option value="#">###</option>
                            </select>
            ...
            <table>
                <thead>
                    <tr>
                        <th>N°</th>
                        <th>CODE CPS DE GENERATION</th>
                        <th>CPS EMPLOYEUR</th>
                        <th>NUMERO QUITTANCE</th>
                        <th>MATRICULE EMPLOYEUR</th>
                        <th>RAISON SOCIALE</th>
                        <th>DATE DE GENERATION</th>
                        <th>UTILISATEUR GENERE</th>
                        <th>MONTANT</th>
                        <th>DATE EDITION</th>
                        <th>UTILISATEUR EDITE</th>
                        <th>DATE TRANSMISSION</th>
                        <th>UTILISATEUR TRANSMISSION</th>
                        <th>TELECHARGER LA QUITTANCE</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
...
export default Listing_quittance;
