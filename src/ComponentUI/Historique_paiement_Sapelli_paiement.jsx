...
const Historique_paiement_Sapelli_paiement = () => {
    return (
        <div>

            <h1>CONSULTATION DES HISTORIQUES DE PAIEMENTS SAPELLI PAIEMENT</h1>
...
export default Historique_paiement_Sapelli_paiement;
