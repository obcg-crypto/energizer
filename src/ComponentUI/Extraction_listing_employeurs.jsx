...
const Extraction_listing_employeurs = () => {
    return (
        <div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select id="search-option">
                                <option value="actif">Effectuee</option>
                                <option value="#">###</option>
                            </select>
                        </td>
                        <td>
                            <select id="search-option">
                                <option value="actif">Non Controle</option>
                                <option value="#">###</option>
                            </select>
                        </td>
                        <td>
...
export default Extraction_listing_employeurs;