...
const Statistiques_paiments_nature_prestation_et_mode_paiement = () => {
    return (
        <div>

            <h1>CONSULTATION DES STATISTIQUES DE PAIEMENT DES PRESTATION SOCIALES PAR NATURE ET PAR PERIODE DE PAIEMENT</h1>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select id="search-option">
                                <option value="centreSvp">EXECUTES</option>
                                <option value="doualaBonanjo">###</option>
                            </select>
                        </td>
                        <td>
                            <div class="search-range">
                                <input type="text" placeholder="Date de paiement" />
                            </div>
                        </td>
                    </tr>
                </tbody>
...
export default Statistiques_paiments_nature_prestation_et_mode_paiement;
