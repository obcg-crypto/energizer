...
const Consultation_bordereaux_edition_APS = () => {
    return (
        <div>
            <table>
                <thead>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="" id="" placeholder='numéro matricule'/>
                        </td>
                        <td>
            ...
            <h3>Consultation des APS éditées au : null</h3>
...
export default Consultation_bordereaux_edition_APS;
