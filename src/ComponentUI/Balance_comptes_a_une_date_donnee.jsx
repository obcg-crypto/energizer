...
const Balance_comptes_a_une_date_donnee = () => {
    return (
        <div>
            <h1>CONSULTATION DES BALANCES DE COTISATION EMPLOYEUR PAR DATE DE MOUVEMENT</h1>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select id="search-option">
                                <option value="centreSvp">Tout le fichier</option>
                                <option value="centreSvp">#</option>
                                <option value="centreSvp">#</option>
                            </select>
                        </td>
...
export default Balance_comptes_a_une_date_donnee;
