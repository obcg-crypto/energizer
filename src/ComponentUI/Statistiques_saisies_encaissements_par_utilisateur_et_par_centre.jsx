...
const Statistiques_saisies_encaissements_par_utilisateur_et_par_centre = () => {
    return (
        <div>
            <h1>EDITION DES LISTES DES EMPLOYEURS</h1>
           
            <table>
                <thead>
                    <tr>
                        <th>CPS DE</th>
                        <th>Position employeur</th>
                        <th>Télédéclaration</th>
                        <th>Controle</th>
                        <th>Mois</th>
                        <th>Année</th>
                   </tr>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select id="search-option">
                                <option value="centreSvp">ACTIF</option>
                                <option value="centreSvp">###</option>
                            </select>
                        </td>
                        <td>
                            <select id="search-option">
                                <option value="centreSvp">EFFECTUEE</option>
                                <option value="centreSvp">###</option>
                            </select>
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="text" name="" id="" placeholder='mois'/>
                        </td>
                        <td>
                            <input type="text" name="" id="" placeholder='année'/>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th>N° Registre de comm/Ref Doc de creation</th>
                        <th>REGIME</th>
                        <th>RISQUE</th>
                        <th>DERNIER MOIS DECLARE</th>
                        <th>ADRESSE</th>
                        <th>BP</th>
                        <th>TELEPHONE</th>
                        <th>Centre impot</th>
                        ...
                        <th>Segment</th>
                        <th>Période dernier segment</th>
                        <th>Mois payés en spontané</th>
                      </tr>
                </thead>
                <tbody>
                    <tr>
...
export default Statistiques_saisies_encaissements_par_utilisateur_et_par_centre;
