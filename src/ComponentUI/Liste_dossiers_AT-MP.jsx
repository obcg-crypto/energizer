...
const Liste_dossiers_ATMP = () => {
    return (
        <div>

            <h1>Dossiers de risques professionnels : CNPS SIEGE</h1>

            <div class="search-container">
                <select id="search-option">
                    <option value="dossier">Num Assuré</option>
...
export default Liste_dossiers_ATMP;
