...
const Brouillard_retenues_par_motif_par_cooperatives = () => {
    return (
        <div class="table-container">

            <h1>EDITION BROUILLARD DES RETENUES PAR COOPERATIVE AU : CNPS SIEGE</h1>
...
export default Brouillard_retenues_par_motif_par_cooperatives;
